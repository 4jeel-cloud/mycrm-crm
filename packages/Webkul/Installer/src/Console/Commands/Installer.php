...
use Webkul\Installer\Database\Seeders\DatabaseSeeder as MetisDatabaseSeeder;
...
class Installer extends Command
{
     ...
     * @var string
     */
    protected $signature = 'metis-crm:install
     ...
     * @var string
     */
    protected $description = 'metis installer.';
    ...
    public function handle()
    {
        ...
        $this->warn('Step: Seeding basic data for Metis kickstart...');
        $this->info(app(MetisDatabaseSeeder::class)->run([
    ...
    protected function createAdminCredentials()
    {
        ...
        try {
            ...
            File::put($filePath, 'Metis is successfully installed');

            $this->info('-----------------------------');
            $this->info('Congratulations!');
            $this->info('The installation has been finished and you can now use Metis.');
